...
SECRET_KEY = '4xfs!#j+b*&gs5$^(oi(qwr7s=aw)qlzngu$xr^@7spl-yhr&b'
...
STATICFILES_DIRS = (
    os.path.join(BASE_DIR, 'charge', 'static'),
)
SITE_ID = 1
...
EMAIL_PORT = 2525
EMAIL_HOST_USER = "saimon.kovalchuk@mail.ru"
EMAIL_HOST_PASSWORD = "mCtljq582994"
EMAIL_USE_TLS = True